    ...
    console.log(
      chalk.yellow(
        `⚠️ ⚠️ ⚠️  It\\'s not recommended to use ${chalk.bold(
          'webpack.config.js',
        )}, since roadhog\\'s major or minor version upgrades may result in incompatibility. If you insist on doing so, please be careful of the compatibility after upgrading roadhog.`,
      ),
    );
    console.log();
  }
