...
exports.default = function (args, appBuild, config, paths) {
  ...
  var finalWebpackConfig = {
    ...
    module: {
      loaders: [{
        exclude: [/\.html$/, /\.(js|jsx)$/, /\.(css|less|scss)$/, /\.json$/, /\.svg$/, /\.tsx?$/],
        loader: 'url',
        query: {
          limit: 10000,
        ...
        test: /\.scss$/,
        include: paths.appSrc,
        loader: _extractTextWebpackPlugin2.default.extract('style', cssLoaders.own.join('!') + '!sass')
      }, {
        test: /\.css$/,
        ...
        test: /\.scss$/,
        include: paths.appNodeModules,
        loader: _extractTextWebpackPlugin2.default.extract('style', cssLoaders.nodeModules.join('!') + '!sass')
      }, {
        test: /\.html$/,
